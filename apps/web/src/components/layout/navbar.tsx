    ...
    <header className="h-16 border-b border-surface-border bg-surface/50 backdrop-blur-md px-4 sm:px-6 flex items-center justify-between sticky top-0 z-10">
      <div className="flex items-center gap-3">
        {onMenuToggle && (
          <button
            ...
            className="lg:hidden p-2 rounded-lg bg-surface-card border border-surface-border text-zinc-300 hover:text-white"
            title="Abrir Menu"
          >
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-surface-card border border-surface-border text-xs text-zinc-300">
          ...
          <span className="font-semibold text-zinc-100 truncate max-w-[150px] sm:max-w-xs">
            {user?.tenantName || 'Loja Principal'}
          </span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-[11px] text-emerald-400">
          ...
          <span className="hidden sm:inline">Online / Produção</span>
